...
('pantalon beige', 549, 'img/img1.avif', 'productos.html', 'pantalon', 'hombre'),
...
('pantalon mezclilla', 479, 'img/img5.png', 'productos.html', 'pantalon', 'hombre'),
('pantalon mezclilla', 389, 'img/img6.jpg', 'productos.html', 'pantalon', 'hombre'),
('pantalon formal', 729, 'img/img7.avif', 'productos.html', 'pantalon', 'mujer'),
...
('pantalon mezclilla', 449, 'img/img15.jfif', 'productos.html', 'pantalon', 'hombre'),
('pantalon mezclilla', 489, 'img/img16.webp', 'productos.html', 'pantalon', 'hombre'),
('pantalon rojo', 499, 'img/img17.avif', 'productos.html', 'pantalon', 'niña'),
...
('pantalon jogger', 449, 'img/img20.png', 'productos.html', 'pantalon', 'niño'),
...
('pantalon jogger', 629, 'img/img23.avif', 'productos.html', 'pantalon', 'niño'),
('pantalon mezclilla', 559, 'img/img24.jpg', 'productos.html', 'pantalon', 'niña'),
('pantalon mezclilla', 699, 'img/img25.jpg', 'productos.html', 'pantalon', 'niño'),
('pantalon jogger', 499, 'img/img26.jpg', 'productos.html', 'pantalon', 'niña'),
('pantalon jogger', 579, 'img/img27.webp', 'productos.html', 'pantalon', 'niña'),
('pantalon mezclilla', 499, 'img/img28.jpg', 'productos.html', 'pantalon', 'niña'),
('pantalon jogger', 579, 'img/img29.avif', 'productos.html', 'pantalon', 'niña'),
('pantalon jogger', 799, 'img/img30.jpg', 'productos.html', 'pantalon', 'niña'),
('pantalon licra', 599, 'img/img31.webp', 'productos.html', 'pantalon', 'niña'),
('Playera Blanca', 359, 'img/img32.jfif', 'productos.html', 'playera', 'mujer'),
('Playera Negra Puma', 239, 'img/img33.jpg', 'productos.html', 'playera', 'mujer'),
('Playera Camuflaje GAP', 289, 'img/img34.avif', 'productos.html', 'playera', 'mujer'),
...
('Playera Beige', 219, 'img/img37.avif', 'productos.html', 'playera', 'mujer'),
('Playera Azul', 259, 'img/img38.webp', 'productos.html', 'playera', 'mujer'),
('Playera Negra Nike', 229, 'img/img39.jpg', 'productos.html', 'playera', 'mujer'),
('Playera Negra', 209, 'img/img40.jfif', 'productos.html', 'playera', 'mujer'),
('Playera Negra Levis', 229, 'img/img41.avif', 'productos.html', 'playera', 'mujer'),
('Playera Rosa', 209, 'img/img42.webp', 'productos.html', 'playera', 'mujer'),
('Playera Negra', 259, 'img/img43.jpeg', 'productos.html', 'playera', 'mujer'),
('Playera Gris/Negra', 189, 'img/img44.jpg', 'productos.html', 'playera', 'hombre'),
('Playera Blanca', 209, 'img/img45.jpg', 'productos.html', 'playera', 'hombre'),
('Playera Blanca', 189, 'img/img46.jfif', 'productos.html', 'playera', 'hombre'),
('Playera Azul Marino', 199, 'img/img47.webp', 'productos.html', 'playera', 'hombre'),
('Playera Gris', 179, 'img/img48.avif', 'productos.html', 'playera', 'hombre'),
('Playera Blanca Estampada', 179, 'img/img49.jpg', 'productos.html', 'playera', 'hombre'),
...
('Playera Rosa', 209, 'img/img54.jfif', 'productos.html', 'playera', 'hombre'),
('Playera Negra', 199, 'img/img55.webp', 'productos.html', 'playera', 'hombre'),
('Playera Blanca', 159, 'img/img56.png', 'productos.html', 'playera', 'hombre'),
('Playera Negra', 129, 'img/img57.jpg', 'productos.html', 'playera', 'hombre'),
('Playera Blanca', 199, 'img/img58.webp', 'productos.html', 'playera', 'hombre'),
('Playera Negra Estampada', 209, 'img/img59.jfif', 'productos.html', 'playera', 'hombre'),
('Playera Blanca Estampada', 259, 'img/img60.webp', 'productos.html', 'playera', 'hombre'),
('Playera Negra Estampada', 289, 'img/img61.jpg', 'productos.html', 'playera', 'hombre'),
